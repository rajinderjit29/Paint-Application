...
paintWindow = np.zeros((471, 636, 3))+250
paintWindow = cv2.rectangle(paintWindow, (40, 1), (140, 65), (0, 0, 0), 2)
paintWindow = cv2.rectangle(paintWindow, (150, 1), (255, 65), colors[0], -1)
...
while True:
    (noFrame, frame )= camera.read()
    frame = cv2.flip(frame, 1)
    hsv = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)

    frame = cv2.rectangle(frame, (40, 1), (140, 65), (122, 122, 122), 2)
    frame = cv2.rectangle(frame, (150, 1), (255, 65), colors[0], -1)
